...
public class EncounterUI : MonoBehaviour
{
    ...
    public GameController CreateDummyGameController() 
        ...
        gameController.AddMusician(new Musician("Bento", new Instrument(InstrumentType.Guitar), Resources.Load<Sprite>("Sprites/Portraits/portrait1")));
        gameController.AddMusician(new Musician("Bort", new Instrument(InstrumentType.Piano), Resources.Load<Sprite>("Sprites/Portraits/portrait2")));
        gameController.AddMusician(new Musician("Bbbbb", new Instrument(InstrumentType.Drum), Resources.Load<Sprite>("Sprites/Portraits/portrait3")));
        gameController.AddMusician(new Musician("Boson", new Instrument(InstrumentType.Bass), Resources.Load<Sprite>("Sprites/Portraits/portrait4")));
